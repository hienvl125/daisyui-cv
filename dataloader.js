...
export default function LoadCV(data) {
  // Section titles
  document.querySelector("#information-section-title").innerHTML = data.informationSectionTitle
  document.querySelector("#skill-section-title").innerHTML = data.skillSectionTitle
  document.querySelector("#about-me-section-title").innerHTML = data.aboutMeSectionTitle
  console.log("data.workExperienceSectionTitle => ", data.workExperienceSectionTitle)
  console.log(document.querySelector("#work-experience-section-title"))
  document.querySelector("#work-experience-section-title").innerHTML = data.workExperienceSectionTitle
  document.querySelector("#education-section-title").innerHTML = data.educationSectionTitle
  ...
  document.querySelector("#work-experience-list").innerHTML = "";
